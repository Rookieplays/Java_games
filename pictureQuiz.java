...
public class pictureQuiz implements ItemListener 
{//call all varibles/contructors to be used out here-->
    ...
    {
        //this Method loads numbers ranging from 1-10 to an arrayList and shuffles them
        //this allows us to pick unique random numbers every time we start the Quiz.
    ...
    /*1.load the random numbers selected
        2.create a comboBox full of the question. 80-->87
        3.get the image from th files. 90-->120
        4.get the coressponding questions,Answers,options. 121-->138
        5.When an option is selected present soring. 144-->180
        6. create GUI. -->220
    ...
    */
    ...
    {//Stores the players stats. gathers the amount of misses theyve had.
    ...
    private static void createAndShowGUI()throws IOException {
        ...
        JFrame frame = new JFrame("pictureQuiz");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        //Create and set up the content pane.
        pictureQuiz demo = new pictureQuiz();
    ...
    public static void main(String[]args)throws IOException //pictureQuiz()throws IOException 
    {
        String start="";
        runQuiz();
    }
    ...
    public static void runQuiz()throws IOException
    {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
               try{ createAndShowGUI();}catch( IOException e){System.out.println("");};
            }
        });
    }
